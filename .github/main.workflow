...
# The following SECRETS must be setup on GitHub for the workflow to execute:
#   - SNYK_TOKEN - See snyk.io
#   - NPM_AUTH_TOKEN  - For publishing to NPM. Ensure 2FA is disabled for the package.
#   - COVERALLS_REPO_TOKEN  - For code coverage with Coveralls
#
